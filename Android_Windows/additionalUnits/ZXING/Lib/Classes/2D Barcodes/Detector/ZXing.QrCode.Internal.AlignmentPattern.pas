...
type
  ...
  IAlignmentPattern = interface(IResultPoint)
    ...
    /// <returns></returns>
    function combineEstimate(const i, j, newModuleSize: Single)
      : IAlignmentPattern;
  end;
  ...
  TAlignmentPatternHelpers = class
    ...
    /// </summary>
    class function CreateAlignmentPattern(const posX, posY, estimatedModuleSize
      : Single): IAlignmentPattern;
  end;
...
class function TAlignmentPatternHelpers.CreateAlignmentPattern(const posX, posY,
  estimatedModuleSize: Single): IAlignmentPattern;
begin
  result := ZXing.QrCode.Internal.AlignmentPatternImplementation.
    NewAlignmentPattern(posX, posY, estimatedModuleSize);
end;
