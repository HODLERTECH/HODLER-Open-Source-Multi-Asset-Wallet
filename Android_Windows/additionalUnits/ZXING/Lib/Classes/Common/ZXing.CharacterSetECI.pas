...
type
  ...
  strict private
    ...
    class procedure addCharacterSet(value: Integer;
      encodingNames: TArray<string>); static;
...
begin
  ...
  // add the instance to the global list of all created instances
end;
...
begin
  ...
  TCharacterSetECI.addCharacterSet(12, ['ISO-8859-4', 'ISO-8859-10',
    'ISO8859_10']);
  TCharacterSetECI.addCharacterSet(13, ['ISO-8859-11', 'ISO8859_11']);
  TCharacterSetECI.addCharacterSet(15, ['ISO-8859-13', 'ISO8859_13']);
  TCharacterSetECI.addCharacterSet($10, ['ISO-8859-1', 'ISO-8859-14',
    'ISO8859_14']);
  TCharacterSetECI.addCharacterSet($11, ['ISO-8859-15', 'ISO8859_15']);
  TCharacterSetECI.addCharacterSet($12, ['ISO-8859-3', 'ISO-8859-16',
    'ISO8859_16']);
...
begin
  ...
  TCharacterSetECI.VALUE_TO_ECI.AddOrSetValue(value, Eci);
  // note : VALUE_TO_ECI[value] := Eci raises "key not found exception": it cant' be used for adding not existing values
