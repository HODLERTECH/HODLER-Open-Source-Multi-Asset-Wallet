...
var
  ...
  rowOffset, x, checkParity: Integer;
begin
  Result := -1;
...
class function TUPCEANExtension2Support.parseExtensionString(const raw: String)
  : TResultMetadata;
var
...
begin
  ...
  dictionary1[ZXing.ResultMetadataType.ISSUE_NUMBER] :=
    TResultMetadata.CreateStringMetadata(raw);
  Result := dictionary1;
end;
