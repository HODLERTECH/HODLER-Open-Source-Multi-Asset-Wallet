...
type
  ...
  protected
    ...
    /// </summary>
    class function crossProductZ(const pointA, pointB, pointC: IResultPoint)
      : Single; static;
  public
    /// <summary>
    ...
    class function CreateResultPoint(const pX, pY: Single)
      : IResultPoint; overload;
    /// <summary>
    ...
    /// </returns>
    class function distance(const pattern1, pattern2: IResultPoint)
      : Single; static;
  end;
...
class function TResultPointHelpers.CreateResultPoint(const pX, pY: Single)
  : IResultPoint;
begin
