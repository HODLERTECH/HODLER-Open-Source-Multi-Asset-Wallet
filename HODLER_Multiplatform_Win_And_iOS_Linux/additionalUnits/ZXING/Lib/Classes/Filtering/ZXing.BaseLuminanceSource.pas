...
type
  ...
  public
    ...
    constructor Create(const luminanceArray: TArray<Byte>;
      const width, height: Integer); reintroduce; overload;
...
/// </returns>
function TBaseLuminanceSource.getRow(const y: Integer; row: TArray<Byte>)
  : TArray<Byte>;
var
  i, width: Integer;
begin
...
/// </returns>
function TBaseLuminanceSource.crop(const left, top, width, height: Integer)
  : TLuminanceSource;
var
  croppedLuminances, oldLuminances: TArray<Byte>;
  oldWidth, oldRightBound, oldBottomBound: Integer;
  yold, ynew, xold, xnew: Integer;
begin
  if ((left + width > Self.width) or (top + height > Self.height)) then
