...
{$IF (DEFINED(MSWINDOWS) OR DEFINED(LINUX))}
  BigQRImagePath := TPath.Combine(DirPath, name + '_' + EncryptedMasterSeed +
    '_' + '_ENC_SEED_QR_BIG' + '.png');
  SmallQRImagePath := TPath.Combine(DirPath, name + '_' + EncryptedMasterSeed +
    '_' + '_ENC_SEED_QR_SMALL' + '.png');
{$ELSE}
