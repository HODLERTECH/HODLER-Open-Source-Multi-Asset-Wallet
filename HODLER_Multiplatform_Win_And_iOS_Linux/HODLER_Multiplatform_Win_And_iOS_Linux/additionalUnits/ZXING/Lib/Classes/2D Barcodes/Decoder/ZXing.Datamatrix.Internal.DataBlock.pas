...
var
  ...
  longerBlocksNumDataCodewords, shorterBlocksNumDataCodewords,
    rawCodewordsOffset, numLongerBlocks, max, iOffset, jOffset: Integer;
...
begin
  ...
  begin
    ...
    begin
      ...
      if (specialVersion and (jOffset > 7)) then
        iOffset := (i - 1)
      else
        iOffset := i;
  ...
  if (not(rawCodewordsOffset = Length(rawCodewords))) then
