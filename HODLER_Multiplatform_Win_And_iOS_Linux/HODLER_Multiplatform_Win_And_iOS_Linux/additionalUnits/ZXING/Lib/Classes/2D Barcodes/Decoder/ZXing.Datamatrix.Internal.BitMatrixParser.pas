...
var
  i, j, symbolSizeRows, dataRegionSizeRows, dataRegionSizeColumns,
    numDataRegionsRow, numDataRegionsColumn, sizeDataRegionRow,
    sizeDataRegionColumn, dataRegionRow, dataRegionRowOffset, dataRegionColumn,
    dataRegionColumnOffset, readRowOffset, writeRowOffset, readColumnOffset,
    writeColumnOffset: Integer;
