...
type
  ...
  public
    constructor Create(const a11, a21, a31, a12, a22, a32, a13, a23,
      a33: Single);

    class function quadrilateralToQuadrilateral(const x0, y0, x1, y1, x2, y2,
      x3, y3, x0p, y0p, x1p, y1p, x2p, y2p, x3p, y3p: Single)
    ...
    class function squareToQuadrilateral(const x0, y0, x1, y1, x2, y2, x3,
      y3: Single): TPerspectiveTransform; static;
...
class function TPerspectiveTransform.quadrilateralToQuadrilateral(const x0, y0,
  x1, y1, x2, y2, x3, y3, x0p, y0p, x1p, y1p, x2p, y2p, x3p, y3p: Single)
...
class function TPerspectiveTransform.squareToQuadrilateral(const x0, y0, x1, y1,
  x2, y2, x3, y3: Single): TPerspectiveTransform;
var
...
begin
  ...
  Result := TPerspectiveTransform.Create(a22 * a33 - a23 * a32,
    a23 * a31 - a21 * a33, a21 * a32 - a22 * a31, a13 * a32 - a12 * a33,
    a11 * a33 - a13 * a31, a12 * a31 - a11 * a32, a12 * a23 - a13 * a22,
    a13 * a21 - a11 * a23, a11 * a22 - a12 * a21);
end;

function TPerspectiveTransform.times(const other: TPerspectiveTransform)
  : TPerspectiveTransform;
begin
  Result := TPerspectiveTransform.Create(a11 * other.a11 + a21 * other.a12 + a31
    * other.a13, a11 * other.a21 + a21 * other.a22 + a31 * other.a23,
    a11 * other.a31 + a21 * other.a32 + a31 * other.a33, a12 * other.a11 + a22 *
    other.a12 + a32 * other.a13, a12 * other.a21 + a22 * other.a22 + a32 *
    other.a23, a12 * other.a31 + a22 * other.a32 + a32 * other.a33,
    a13 * other.a11 + a23 * other.a12 + a33 * other.a13, a13 * other.a21 + a23 *
    other.a22 + a33 * other.a23, a13 * other.a31 + a23 * other.a32 + a33 *
    other.a33);
end;
