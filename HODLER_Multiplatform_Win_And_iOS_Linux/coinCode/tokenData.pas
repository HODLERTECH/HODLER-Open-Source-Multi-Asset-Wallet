...
type
  ...
  const // if address = ''  token no longer exists
    availableToken: array [0 .. 26] of tokenInfo = (
      (id: 10000; name: 'HODLER.TECH'; shortcut: 'HDL';
      address: '0x95c4be8534d69c248c0623c4c9a7a2a001c17337'; decimals: 18; ResourceName : 'HDL_IMG';

      ), (id: 10001; name: 'Maker'; shortcut: 'MKR';
      address: '0x9f8f72aa9304c8b593d555f12ef6589cc3a579a2'; decimals: 18; ResourceName : 'MAKER_IMG';

      ), (id: 10002; name: 'Tronix'; shortcut: 'TRX';
      address: '' { '0xf230b790e05390fc8295f4d3f60332c93bed42e2' }; decimals: 6;ResourceName : '_IMG';

      ), (id: 10003; name: 'VeChain'; shortcut: 'VEN'; address: '' { ..... };
      decimals: 18;ResourceName : 'VECHAIN_IMG';

      ), (id: 10004; name: 'Binance Coin'; shortcut: 'BNB';
      address: '0xB8c77482e45F1F44dE1745F52C74426C631bDD52'; decimals: 18;ResourceName : 'BINANCECOIN_IMG';

      ), (id: 10005; name: 'OmiseGO'; shortcut: 'OMG';
      address: '0xd26114cd6EE289AccF82350c8d8487fedB8A0C07'; decimals: 18;ResourceName : 'OMNISEGO_IMG';
      ...
      address: '0x5ca9a71b1d01849c0a95490cc00559717fcf0d1d'; decimals: 18; ResourceName : 'AETERNITY_IMG';

      ), (id: 10009; name: 'Bytom'; shortcut: 'BTM';
      address: '0xcb97e65f07da24d46bcdd078ebebd7c6e6e3d750'; decimals: 8; ResourceName : 'BYTOM_IMG';

      ), (id: 10010; name: '0x'; shortcut: 'ZRX';
      address: '0xe41d2489571d322189246dafa5ebde1f4699f498'; decimals: 18; ResourceName : 'ZRX_IMG';

      ), (id: 10011; name: 'LAtoken'; shortcut: 'LA';
      address: '0xe50365f5d679cb98a1dd62d6f6e58e59321bcddf'; decimals: 18;ResourceName : 'LATOKEN_IMG';

      ), (id: 10012; name: 'Algory'; shortcut: 'ALG';
      address: '0x16b0a1a87ae8af5c792fabc429c4fe248834842b'; decimals: 18; ResourceName : 'ALGORY_IMG';
      ...
      ), (id: 10014; name: 'USD Coin';
      shortcut: 'USDC'; address: '0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48';
      decimals: 6; stableCoin: true; stableValue: 1; ResourceName : 'USDCOIN_IMG';

      ), (id: 10015;
      name: 'Paxos Standard'; shortcut: 'PAX';
      ...
      ), (id: 10016; name: 'TrueUSD';
      shortcut: 'TUSD'; address: '0x8dd5fbce2f6a956c3022ba3663759011dd51e73e';
      decimals: 18; stableCoin: true; stableValue: 1; ResourceName : 'TRUEUSD_IMG';

      ), (id: 10017;
      name: 'Bit-Z Token'; shortcut: 'BZ';
      address: '0x4375e7ad8a01b8ec3ed041399f62d9cd120e0063'; decimals: 18; ResourceName : 'BITZTOKEN_IMG';

      ), (id: 10018; name: 'Moeda Loyalty Points MDA'; shortcut: 'MDA';
      address: '0x51db5ad35c671a87207d88fc11d593ac0c8415bd'; decimals: 18; ResourceName : 'MDA_IMG';

      ), (id: 10019; name: 'MobileGo'; shortcut: 'MGO';
      address: '0x40395044Ac3c0C57051906dA938B54BD6557F212'; decimals: 8; ResourceName : 'MOBILEGO_IMG';

      ), (id: 10020; name: 'Huobi Token'; shortcut: 'HT';
      address: '0x6f259637dcd74c767781e37bc6133cd6a68aa161'; decimals: 18; ResourceName : 'HUOBITOKEN_IMG';

      ), (id: 10021; name: 'TrueChain'; shortcut: 'TRUE';
      address: '0xA4d17AB1eE0efDD23edc2869E7BA96B89eEcf9AB'; decimals: 18;ResourceName : 'TRUECHAIN_IMG';

      ), (id: 10022; name: 'Request Network'; shortcut: 'REQ';
      address: '0x8f8221afbb33998d8584a2b05749ba73c37a938a'; decimals: 18; ResourceName : 'REQUESTNETWORK_IMG';
      ...
      address: '0xb63b606ac810a52cca15e44bb630fd42d8d1d83d'; decimals: 8; ResourceName : 'CRYPTOCOM_IMG';

      ), (id: 10025; name: 'Kyber Network'; shortcut: 'KNC';
      address: '0xdd974d5c2e2928dea5f71b9825b8b646686bd200'; decimals: 18; ResourceName : 'KYBERNETWORK_IMG';

      ), (id: 10026; name: 'Nebulas'; shortcut: 'NAS';
      address: '0x5d65D971895Edc438f465c17DB6992698a52318D'; decimals: 18 ;ResourceName : 'NEBULAS_IMG';));
  end;
