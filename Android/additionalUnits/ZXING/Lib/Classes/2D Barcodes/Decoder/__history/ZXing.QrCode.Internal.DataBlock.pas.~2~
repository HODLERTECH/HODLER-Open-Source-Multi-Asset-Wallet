...
class function TDataBlock.getDataBlocks(const rawCodewords: TArray<Byte>;
  ...
  : TArray<TDataBlock>;
var
  numResultBlocks, shorterBlocksTotalCodewords, longerBlocksStartAt,
    shorterBlocksNumDataCodewords, max, i, j, totalBlocks, numBlockCodewords,
    iOffset, rawCodewordsOffset, NumDataCodewords: Integer;
