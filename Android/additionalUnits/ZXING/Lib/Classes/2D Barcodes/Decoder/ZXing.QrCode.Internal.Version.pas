...
type
  ...
  public
    ...
    class function getProvisionalVersionForDimension(const dimension: Integer)
      : TVersion; static;
    class function getVersionForNumber(const versionNumber: Integer)
      : TVersion; static;
...
class function TVersion.getProvisionalVersionForDimension(const dimension
  : Integer): TVersion;
begin
  result := nil;
...
class function TVersion.getVersionForNumber(const versionNumber: Integer)
  : TVersion;
begin
