...
type
  ...
  const
    ...
    class function decodeAlphanumericSegment(const bits: TBitSource;
      const res: TStringBuilder; count: Integer; const fc1InEffect: Boolean)
      : Boolean; static;
...
var
  ...
  fc1InEffect: Boolean;
  symbolSequence, parityData, count, value, countHanzi, subSet: Integer;
...
begin
  ...
  try
    try
            ...
            begin
              ...
              begin
                ...
                currentCharacterSetECI :=
                  TCharacterSetECI.getCharacterSetECIByValue(value);
              ...
              begin
                ...
                begin
                  ...
                  begin
                    ...
                    begin
                      if (not TDecodedBitStreamParser.decodeAlphanumericSegment
                        (bits, res, count, fc1InEffect)) then
                        exit;
                    end
                    else
                    begin
                      ...
                      begin
                        if (not TDecodedBitStreamParser.decodeByteSegment(bits,
                          res, count, currentCharacterSetECI, ByteSegments,
                          hints)) then
                          exit;
                      end
                      else
                      begin
                        ...
                        begin
                          if (not TDecodedBitStreamParser.decodeKanjiSegment
                            (bits, res, count)) then
                            exit;
                        end
                        else
      ...
      until (Mode = TMode.TERMINATOR) except on E: EArgumentException do
      exit;
    end;
    ...
    Result := TDecoderResult.Create(bytes, s, ByteSegments, ecstring,
...
begin
  ...
  begin
    ...
    if (assembledTwoBytes < $003BF) then
