...
function NewAlignmentPattern(const posX, posY, estimatedModuleSize: Single)
  : IAlignmentPattern;
...
type
  ...
  ///
  /// </summary>
  TAlignmentPattern = class sealed(TResultPoint, IResultPoint,
    IAlignmentPattern)
  private
...
function TAlignmentPattern.combineEstimate(const i, j, newModuleSize: Single)
  : IAlignmentPattern;
var
  combinedX, combinedY, combinedModuleSize: Single;
begin
