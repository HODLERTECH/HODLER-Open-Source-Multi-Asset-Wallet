...
function NewFinderPattern(const posX, posY, estimatedModuleSize: Single;
  const count: Integer): IFinderPattern; overload;
function NewFinderPattern(const posX, posY, estimatedModuleSize: Single)
  : IFinderPattern; overload;
...
constructor TFinderPattern.Create(const posX, posY, estimatedModuleSize: Single;
  const count: Integer);
begin
...
constructor TFinderPattern.Create(const posX, posY, estimatedModuleSize
  : Single);
begin
...
function TFinderPattern.combineEstimate(const i, j, newModuleSize: Single)
  : IFinderPattern;
var
...
function NewFinderPattern(const posX, posY, estimatedModuleSize: Single;
  const count: Integer): IFinderPattern;
begin
