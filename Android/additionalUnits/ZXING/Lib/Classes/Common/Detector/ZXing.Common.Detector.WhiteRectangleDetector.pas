...
begin
  ...
  begin
    Result := TArray<IResultPoint>.Create
      (TResultPointHelpers.CreateResultPoint((ti - 1), (tj + 1)),
      TResultPointHelpers.CreateResultPoint((zi + 1), (zj + 1)),
      TResultPointHelpers.CreateResultPoint((xi - 1), (xj - 1)),
      TResultPointHelpers.CreateResultPoint((yi + 1), (yj - 1)));
    exit;
  end;
