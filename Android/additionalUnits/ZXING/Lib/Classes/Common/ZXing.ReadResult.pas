...
type
  ...
  public
    ...
    class function CreateIntegerMetadata(const Value: Integer)
      : IIntegerMetadata;
    class function CreateByteSegmentsMetadata(const Value: IByteSegments)
      : IByteSegmentsMetadata;
  end;
  ...
  public
    ...
    property ResultMetaData: TResultMetaData read FResultMetadata
      write SetMetaData;
...
type
  TByteSegmentsMetadata = class(TInterfacedObject, IMetaData,
    IByteSegmentsMetadata)
  strict private
...
class function TResultMetaData.CreateStringMetadata(const Value: string)
  : IStringMetadata;
begin
...
class function TResultMetaData.CreateIntegerMetadata(const Value: Integer)
  : IIntegerMetadata;
begin
...
begin
  ...
  // we need to free existing object instance, for old-gen compilers
