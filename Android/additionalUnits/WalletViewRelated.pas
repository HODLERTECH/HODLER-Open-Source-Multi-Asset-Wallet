...
begin
  ...
  begin
    ...
    if TwalletInfo(CurrentCryptoCurrency).coin <> 2 then
    begin
      InstantSendLayout.Visible := false;
      PrivateSendLayout.Visible := false;
      SendSettingsFlowLayout.Height := 42;
      TransactionFeeLayout.Height := 200;
    end
    else
    begin
      InstantSendLayout.Visible := true;
      PrivateSendLayout.Visible := true;
      SendSettingsFlowLayout.Height := 84;
      TransactionFeeLayout.Height := 242;
    end;
    ...
    begin
      ...
      begin
        lblFee.Text := wvFee.Text + '  = ' +
          floatToStrF(frmHome.CurrencyConverter.calculate
          (strToFloatDef(wvFee.Text, 0) * 66666 * CurrentCryptoCurrency.rate /
          (1000000.0 * 1000000.0 * 1000000.0)), ffFixed, 18, 6) + ' ' +
